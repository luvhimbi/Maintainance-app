                            ...
                            <div class="card shadow-sm h-100 border-0">
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 mt-3">
                                        <div class="col-12">
                                            ...
                                            <select class="form-select border-primary" name="safety_hazard" id="safety_hazard">
                                                <option value="0" {{ (old('safety_hazard', $formData['safety_hazard'] ?? 0) == '0') ? 'selected' : '' }}>No</option>
                                                <option value="1" {{ (old('safety_hazard', $formData['safety_hazard'] ?? 0) == '1') ? 'selected' : '' }}>Yes</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        <div class="form-check">
                                            ...
                                            <input class="form-check-input"
                                                   ...
                                                   value="1"
                                                {{ old('affects_operations', $formData['affects_operations'] ?? 0) ? 'checked' : '' }}>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="number" class="form-control border-primary" name="affected_areas" id="affected_areas" value="{{ old('affected_areas', $formData['affected_areas'] ?? 1) }}" min="1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow-sm h-100 border-0">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mb-3 flex-grow-1">
                                        ...
                                        <textarea class="form-control border-primary" name="issue_description" id="issue_description" rows="7" required>{{ old('issue_description') ?? ($formData['issue_description'] ?? '') }}</textarea>
                                    </div>
                                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    // SweetAlert for error messages (Laravel session based)
    @if(session('error'))
    Swal.fire({
        icon: 'error',
        title: 'Error!',
