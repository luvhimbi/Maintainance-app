                ...
                <div class="card shadow-sm border-0 rounded-3 mb-4">
                    <div class="card-header bg-white border-bottom-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="h4 fw-bold mb-0">Technician Profile</h2>
                            <a href="{{ route('tech_edit') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <h3 class="h5 fw-bold border-bottom pb-2 mb-3">Professional Information</h3>
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-capitalize">{{ $user->user_role }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-circle bg-light-info me-3">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-bold">Specialization</p>
                                            <p class="mb-0">{{ $maintenanceStaff->specialization }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-circle bg-light-info me-3">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-bold">Availability</p>
                                            <span class="badge
                                            @if($maintenanceStaff->availability_status == 'Available') bg-success
                                            @elseif($maintenanceStaff->availability_status == 'On Leave') bg-warning
                                            @else bg-secondary
                                            @endif">
                                            {{ $maintenanceStaff->availability_status }}
                                        </span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-bold">Current Workload</p>
                                            <p class="mb-0">{{ $maintenanceStaff->current_workload }} tasks</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
