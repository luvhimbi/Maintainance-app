        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.buildings.update', $building->id) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="latitude" 
                                                   name="latitude" 
                                                   value="{{ old('latitude', $building->latitude) }}" 
                                                   required>
                                            @error('latitude')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="longitude" 
                                                   name="longitude" 
                                                   value="{{ old('longitude', $building->longitude) }}" 
                                                   required>
                                            @error('longitude')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info mt-3 mb-0">
                                            Click on the map to update the building location
                                        </div>
                                    </div>
                                </div>
                            </div>
