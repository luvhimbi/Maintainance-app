                ...
                <div class="card shadow-sm border-0 rounded-3 mb-4">
                    <div class="card-header bg-white border-bottom-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="h4 fw-bold mb-0">Admin Profile</h2>
                            <a href="{{ route('adminEdit') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    <h3 class="h5 fw-bold border-bottom pb-2 mb-3">Administrative Information</h3>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-circle bg-light-info me-3">
                                            <i class="fas fa-id-card text-info"></i>
                                        </div>
                                        <div>
                                            <p class="mb-0 fw-bold">Admin ID</p>
                                            <p class="mb-0">{{ $admin->user_id }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="icon-circle bg-light-info me-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">{{ $admin->department }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p class="mb-0 fw-bold">Admin Since</p>
                                            <p class="mb-0">{{ \Carbon\Carbon::parse($admin->created_at)->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
