...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('longitude').value = defaultCenter[0].toFixed(6);
            document.getElementById('latitude').value = defaultCenter[1].toFixed(6);
            updateLocationInfo({ lat: defaultCenter[1], lng: defaultCenter[0] });
