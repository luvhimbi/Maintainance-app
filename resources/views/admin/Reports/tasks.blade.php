        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom py-3 px-4 rounded-top-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                    <div>
                        <h1 class="h5 fw-bold mb-1 text-dark">Maintenance Task Report</h1>
                        <p class="text-muted small mb-0">Overview of maintenance tasks
                ...
                <form method="GET" action="{{ route('admin.reports.tasks') }}" class="row g-3 align-items-end">
                    ...
                    <div class="col-12 col-md-2">
                        <label for="priority" class="form-label small text-muted mb-0">Priority</label>
                    ...
                    <div class="col-12 col-md-2 d-flex align-items-end">
                        <button type="submit" class="btn btn-primary btn-sm rounded-pill px-3 me-2 w-100">
                            <i class="fas fa-filter me-1"></i> Apply
                        </button>
                        <a href="{{ route('admin.reports.tasks') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3 w-100">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="exportDropdown">
                            <li><a class="dropdown-item" href="{{ route('tasks.export.pdf', request()->query()) }}"><i class="fas fa-file-pdf me-2"></i> Export to PDF</a></li>
                            <li><a class="dropdown-item" href="{{ route('tasks.export.excel', request()->query()) }}"><i class="fas fa-file-excel me-2"></i> Export to Excel</a></li>
                            <li><a class="dropdown-item" href="{{ route('tasks.export.word', request()->query()) }}"><i class="fas fa-file-word me-2"></i> Export to Word</a></li>
                            <li><a class="dropdown-item" href="#" id="exportTaskJpg"><i class="fas fa-file-image me-2"></i> Export to JPG</a></li>
            ...
            <div class="card-body p-4 pt-0">
                <div class="row mb-4 g-3">
                    ...
                    <div class="col-md-3">
                        <div class="card border-start border-success border-3 h-100 shadow-sm-hover">
                            <div class="card-body">
                                ...
                                <h3 class="card-title text-success">{{ $stats['completed'] }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="card border-start border-danger border-3 h-100 shadow-sm-hover">
                            <div class="card-body">
                                <h6 class="card-subtitle mb-2 text-muted">Overdue</h6>
                                <h3 class="card-title text-danger">{{ $stats['overdue'] }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center rounded-top-4">
                        <h5 class="mb-0 fw-bold text-dark">Task Details</h5>
                        <span class="badge bg-secondary-subtle text-secondary fw-medium py-2 px-3 rounded-pill">{{ $tasks->total() }} tasks</span>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                @forelse ($tasks as $task)
                                    <tr class="{{ $task->expected_completion < now() && $task->issue_status != 'completed' ? 'table-danger-light' : '' }}">
                                        ...
                                        <td>
                                            <span class="badge rounded-pill
                                                @if($task->issue_status == 'completed') bg-success-subtle text-success
                                                @elseif($task->issue_status == 'pending') bg-warning-subtle text-warning
                                                @elseif($task->issue_status == 'in_progress') bg-primary-subtle text-primary
...
@push('styles')
    <style>
        ...
        .table-danger-light { /* For overdue tasks */
            background-color: #fff3f5; /* Light red background */
        }
    </style>
@endpush
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('exportTaskJpg').addEventListener('click', function(event) {
                ...
                if (reportCard) {
                    html2canvas(reportCard, {
                        ...
                        link.download = 'maintenance_task_report.jpg';
